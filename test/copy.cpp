...
// float closestMarkerDistance = std::numeric_limits<float>::max();
            ...
            for (unsigned int i = 0; i < TheMarkers.size(); i++)
			{
                ...
                // cout<<"1"<<endl;
// for (unsigned int j = 0; j < TheMarkers.size(); j++) {
//     // 计算 ArUco 二维码的位置或其他适当的标准来确定 "近" 的含义
//     float distanceToMarker = calculateDistanceToMarker(TheMarkers[j], TheCameraParameters);
    
//     // 更新最近的 ArUco 二维码信息
//     if (distanceToMarker < closestMarkerDistance) {
//         closestMarkerDistance = distanceToMarker;
//         closestMarkerId = TheMarkers[j].id;
//     }
// }
//                 // cout<<"1"<<endl;
